...
@SqlResultSetMapping(name = "RiepilogoMapping", classes = @ConstructorResult(
        targetClass = RiepilogoResultSet.class,
        columns = {
                @ColumnResult(name = "dipendente"),
                @ColumnResult(name = "gennaio", type = Double.class),
                @ColumnResult(name = "febbraio", type = Double.class),
                @ColumnResult(name = "marzo", type = Double.class),
                @ColumnResult(name = "aprile", type = Double.class),
                @ColumnResult(name = "maggio", type = Double.class),
                @ColumnResult(name = "giugno", type = Double.class),
                @ColumnResult(name = "luglio", type = Double.class),
                @ColumnResult(name = "agosto", type = Double.class),
                @ColumnResult(name = "settembre", type = Double.class),
                @ColumnResult(name = "ottobre", type = Double.class),
                @ColumnResult(name = "novembre", type = Double.class),
                @ColumnResult(name = "dicembre", type = Double.class),
                @ColumnResult(name = "progetti"),
                @ColumnResult(name = "pianificato", type = Double.class)
        }
))
